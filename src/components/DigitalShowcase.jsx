...
const PhoneFrame = ({ accent = "#3b82f6", label = "Phone screen placeholder" , src}) => (
  ...
  >
    ...
    <div className="absolute top-[14px] left-1/2 -translate-x-1/2 w-16 h-4 rounded-full z-10"
      />
    {/* Screen placeholder */}
    <div className="absolute inset-[6px] rounded-[33px] flex flex-col items-center justify-center gap-2 overflow-hidden">
...
const Section1 = () => (
  <section className="bg-[#eaf3fb] pb-20">
    <Marquee />
    <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mt-32">
      {/* Left text */}
      <div>
      ...
      <div className="relative flex justify-center items-center gap-6">
        ...
        {/* Feature card */}
        <div className="hidden md:block  p-6 max-w-[240px] ">
          <p className="text-[14px] font-semibold text-black  tracking-[1.5px] mb-3  w-[300px]">
            Fully compliant with regulatory requirements
          </p>
          <p className="text-[13px] text-gray-500 mb-5 leading-relaxed w-[250px]">
      ...
      <div className="w-full lg:w-1/2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex justify-center">
            <PhoneFrame
              accent="#ec4899"
              label="Dashboard / chart screenshot"
              src="/iPhone2.png"
            />
          </div>
      ...
      <div className="w-full lg:w-1/2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex justify-center order-2 lg:order-1">
            <PhoneFrame
              accent="#ec4899"
              label="Mobile banking app screenshot"
              src="/iPhone3.png"
            />
          </div>
...
const DigitalShowcase = () => (
  <div className="font-sans relative">
    <img src="/N7.png" alt="Background Logo" className="absolute top-[220px] left-[600px] right-0 w-[600px] h-[500px]  z-0" />
    <img src="/BackLogo.png" alt="Background Logo" className="absolute top-[460px] left-0 right-48 w-[600px] h-[1245px]  z-0" />
    <Section1 />
    <Section2 />
    <Section3 />
